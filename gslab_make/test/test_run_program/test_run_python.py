...
from py.run_program import run_python
...
class testRunPython(unittest.TestCase):
    ...
    def test_custom_log(self):
        ...
        with nostderrout():
            clear_dirs(output_dir)
            start_make_logging(makelog_file)
            run_python(program = './input/python_test_script.py', makelog = '../output/custom_make.log')
    ...
    def test_independent_log(self):
        ...
        self.assertTrue(self.last_line_equals('../output/python.log', 'Test script complete\n'))
        self.assertTrue(os.path.isfile('output.txt'))
