...
sys.path.append('..')
from py.dir_mod import list_directory
...
class testListDirectory(unittest.TestCase):
    ...
    def setUp(self):
        ...
        get_externals('./input/externals_list_directory.txt', './input/externals_list_directory/', '', quiet = True)
    ...
    def test_custom_log(self):
        ...
        with nostderrout():
            clear_dirs(output_dir)
            start_make_logging(makelog_file)
            list_directory('./input/externals_list_directory/', '../output/custom_make.log')
        self.check_log('./input/externals_list_directory/', makelog_file)
        self.check_log('./input/externals_list_directory/internal/', makelog_file)
